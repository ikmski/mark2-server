...
type UserInfo struct {
	...
	Status  UserStatus `protobuf:"varint,4,opt,name=status,enum=mark2.UserStatus" json:"status,omitempty"`
}
...
type RoomInfo struct {
	...
	Status   RoomStatus  `protobuf:"varint,3,opt,name=status,enum=mark2.RoomStatus" json:"status,omitempty"`
...
func (m *RoomInfo) GetCapacity() int32 {
	if m != nil {
		return m.Capacity
	}
	return 0
...
type Message struct {
	...
	FromUser *UserInfo   `protobuf:"bytes,3,opt,name=from_user,json=fromUser" json:"from_user,omitempty"`
...
func (m *LoginRequest) GetGroupId() int32 {
	if m != nil {
		return m.GroupId
	}
	return 0
...
func (m *CreateRoomRequest) GetCapacity() int32 {
	if m != nil {
		return m.Capacity
	}
	return 0
...
var fileDescriptor0 = []byte{
	...
	,
}
